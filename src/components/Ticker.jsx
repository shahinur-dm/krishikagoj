...
export default function Ticker() {
  const { headlines, latest } = useSiteData()
  const items = (headlines.length ? headlines : latest).slice(0, 10)
  ...
  // After the clone of the first headline slides in, jump back to the real first one
  useEffect(() => {
