...
function slimSettings(s) {
  ...
  return {
    ...
    newsStoriesTitle: s.newsStoriesTitle || s.newsStoriesTitleBn || '',
    newsStoriesTitleBn: s.newsStoriesTitleBn || s.newsStoriesTitle || '',
    newsStoriesTitleEn: s.newsStoriesTitleEn || '',
